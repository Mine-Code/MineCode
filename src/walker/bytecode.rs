...
impl Walker for ByteCodeWalker {
    ...
    fn walk_expr(&mut self, expr: Expr) -> Vec<u8> {
        match expr {
    ...
    fn walk_ranged(&mut self, start: Expr, end: Expr) -> Vec<u8> {
        unimplemented!()
    }
    ...
    fn walk_compile_time(&mut self, expr: Expr) -> Vec<u8> {
        unimplemented!()
    }
    ...
    fn walk_logical_not(&mut self, expr: Expr) -> Vec<u8> {
        unimplemented!()
    }
    fn walk_bitwise_not(&mut self, expr: Expr) -> Vec<u8> {
        unimplemented!()
    }
    fn walk_negative(&mut self, expr: Expr) -> Vec<u8> {
        unimplemented!()
    }
    ...
    fn walk_attribute(&mut self, expr: Expr, attr: String) -> Vec<u8> {
        unimplemented!()
    }
    fn walk_if(&mut self, branches: Vec<(Expr, Expr)>, fallback: Option<Expr>) -> Vec<u8> {
    ...
    fn walk_for(&mut self, name: String, iter: Expr, body: Expr, value: Option<Expr>) -> Vec<u8> {
        unimplemented!()
    }
    ...
    fn walk_func_def(&mut self, name: String, args: Vec<String>, body: Expr) -> Vec<u8> {
        unimplemented!()
    }
}
